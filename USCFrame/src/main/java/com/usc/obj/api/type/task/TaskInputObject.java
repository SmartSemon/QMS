...
public class TaskInputObject extends GeneralObject implements USCHierarchyObject
{
	...
	private TaskInputObject[] inputs;

	public TaskInputObject(String objType, HashMap<String, Object> map)
	{
		super(objType, map);
	}
...
//
	...
	public boolean hasChildren()
	{
		...
		if ("0".equals(pid))
		{
			this.inputs = (TaskInputObject[]) getChildren();
	...
	public USCObject[] getChildren()
	{
		if (ObjectHelperUtils.isEmpty(inputs))
		{
			...
			if (children != null)
			{
				inputs = (TaskInputObject[]) children;
			}
		}
