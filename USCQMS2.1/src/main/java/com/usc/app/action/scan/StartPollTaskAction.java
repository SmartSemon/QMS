...
@RestController
public class StartPollTaskAction extends AbstractAction
{
	...
	public Object executeAction() throws Exception
	{
		...
		if (clazz != null)
		{
			String url = "http://localhost:8899/poll/start";
			...
			{
				object.setFieldValue("isenable", true);
				object.setFieldValue("starttime", SystemTime.getTimestamp());
				object.save(context);
				return new ActionMessage(flagTrue, "M", "启用轮询任务成功", null, object.getFieldValues());
			}
		}
